...
public class GuestStayFacade(Database database, EventBus eventBus)
{
    ...
    public ValueTask RecordPayment(RecordPayment command)
    {
        // TODO: Fill the implementation calling your entity/aggregate
        throw new NotImplementedException("TODO: Fill the implementation calling your entity/aggregate");
    }

    public ValueTask CheckOutGuest(CheckOutGuest command)
    {
        // TODO: Fill the implementation calling your entity/aggregate
        throw new NotImplementedException();
    }

    public ValueTask CheckOutGroup(InitiateGroupCheckout command)
    {
        // TODO: Fill the implementation calling your entity/aggregate
        throw new NotImplementedException();
    }

    public ValueTask InitiateGroupCheckout(InitiateGroupCheckout command)
    {
        // TODO: Fill the implementation calling your entity/aggregate
        throw new NotImplementedException();
    }

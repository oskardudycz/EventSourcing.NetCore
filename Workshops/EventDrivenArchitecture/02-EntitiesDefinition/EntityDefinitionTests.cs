...
public class EntityDefinitionTests
{
    ...
    [Fact]
    public async Task CheckingOutGuestWithSettledBalance_DoesNotRecordAnyEvent()
    {
        // Given
        var guestStayId = Guid.NewGuid();
        ...
        // Then
        publishedEvents.ShouldNotReceiveAnyEvent();
    }
    ...
    public async Task GroupCheckoutForMultipleGuestStay_ShouldBeInitiated()
    {
        ...
        // Then
        publishedEvents.ShouldReceiveSingleEvent(new GroupCheckoutInitiated(groupCheckoutId, clerkId, guestStays, now));
    }

...
// As passwords are unescaped for some reason in connection string
// using this from https://github.com/dotnet/aspire-samples/blob/d674e52ba5d03755ad3a8e73656cd83995084d25/samples/Shared/ParameterExtensions.cs
...
internal static class ParameterExtensions
{
    ...
    public static IResourceBuilder<ParameterResource> CreateStablePassword(this IDistributedApplicationBuilder builder, string name,
        bool lower = true, bool upper = true, bool numeric = true, bool special = false, // updated from true
        int minLower = 0, int minUpper = 0, int minNumeric = 0, int minSpecial = 0)
    {
        ...
        return ResourceBuilder.Create(new ParameterResource("carts-password", _ => "dummy"), builder);
    }

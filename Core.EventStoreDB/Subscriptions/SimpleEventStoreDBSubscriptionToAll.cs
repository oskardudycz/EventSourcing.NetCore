...
//
// public class SimpleEventStoreDBSubscriptionToAllOptions
// {
...
// }
//
// public class SimpleEventStoreDBSubscriptionToAll(
//     EventStoreClient eventStoreClient,
//     IServiceProvider serviceProvider,
//     ILogger<SimpleEventStoreDBSubscriptionToAll> logger
// )
// {
//     private SimpleEventStoreDBSubscriptionToAllOptions subscriptionOptions = default!;
//     private string SubscriptionId => subscriptionOptions.SubscriptionId;
//
//     public async Task SubscribeToAll(SimpleEventStoreDBSubscriptionToAllOptions subscriptionOptions, CancellationToken ct)
//     {
...
//
//             await foreach (var events in subscription.Batch(subscriptionOptions.BatchSize, ct).ConfigureAwait(false))
//             {
...
//         SimpleEventStoreDBSubscriptionToAllOptions subscriptionOptions,

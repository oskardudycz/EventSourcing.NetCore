...
public abstract class ApiFixture<TProgram>: IAsyncLifetime where TProgram : class
{
    protected readonly TestContext<TProgram> Sut;
    ...
    public virtual TestContext<TProgram> CreateTestContext() => new(SetupServices);
